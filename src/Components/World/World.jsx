...
const Business = () => {
  ...
  const currentPosts = technologyData.slice(indexofFirstPage,indexofLastPost);
      ...
      <Container>
       ...
       <Skeleton_Loading/>
          ...
          currentPosts.map((item, index) =>(
            ...
            <Pagination  postsPerPage={postsPerPage} totalPosts ={technologyData.length} paginate={paginate} />
